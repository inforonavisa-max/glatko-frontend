      ...
      <div className="min-h-screen flex items-center justify-center px-4">
        <div className="relative z-10 w-full max-w-md">
          <div className="rounded-2xl border border-gray-200 dark:border-white/10 bg-white/90 dark:bg-white/[0.04] backdrop-blur-xl p-10 text-center">
            ...
            <Link href="/login" className="mt-8 inline-flex items-center justify-center rounded-xl bg-gradient-to-r from-teal-500 to-teal-600 shadow-lg shadow-teal-500/25 hover:shadow-teal-500/40 px-6 py-3 text-sm font-semibold text-white transition-all">{t("auth.backToLogin")}</Link>
          </div>
        </div>
      </div>
      </PageBackground>
