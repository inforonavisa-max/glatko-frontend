...
function Toggle({
  ...
  return (
    <button
      ...
      className={cn(
        "relative inline-flex h-6 w-11 shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-teal-500/30 focus:ring-offset-2 dark:focus:ring-offset-[#0b1f23]",
