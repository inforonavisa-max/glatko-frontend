...
/**
 * Adapted from Aceternity Pro template `components/cta.tsx`:
 * - FeaturedImages (lines 69–212)
 * - testimonials array (lines 214–251)
 * react-icons → lucide-react Star; Cal.com button removed (handled by page CTA links).
 */
...
export function CtaFeaturedImages({
  caption,
  textClassName,
  className,
  showStars = false,
  containerClassName,
}: CtaFeaturedImagesProps) {
  ...
  return (
    <div
      className={cn(
        "flex flex-col items-center mt-6 mb-2 md:mt-0 md:mb-4",
        containerClassName
      )}
    >
      <div
            ...
            >
              ...
              <div className="animation-container">
                <motion.div
                  ...
                  className="rounded-2xl overflow-hidden border-2 border-neutral-200 dark:border-neutral-600 relative"
                >
                  <Image
        ...
        <div className="flex justify-center ml-6">
          {[...Array(5)].map((_, index) => (
            <Star
              ...
              className={cn(
                showStars
                  ? "h-4 w-4 fill-amber-400 text-amber-400 mx-1"
                  : "hidden"
              )}
              aria-hidden
            />
      ...
      <p
        className={cn(
          "text-neutral-500 dark:text-neutral-400 text-sm text-left relative z-40",
          textClassName
        )}
      >
        {caption}
