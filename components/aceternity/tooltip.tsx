/**
 * Aceternity Pro — Tooltip (mobile-aware)
 * Source: ui.aceternity.com/components/tooltip
 ...
 *   - identifiers `rect.top`, `containerRect.top` restored from corrupted
 *     markdown-link paste artefacts
 */
"use client";
