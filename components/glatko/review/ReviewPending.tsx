  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="mt-8 w-full rounded-2xl border border-gray-200 bg-gray-50 p-5 backdrop-blur-sm dark:border-white/[0.08] dark:bg-white/[0.03]"
      >
      ...
      <Link
        href="/dashboard"
        className="mt-8 rounded-xl border border-gray-200 px-6 py-3 text-sm font-medium text-gray-600 transition-all hover:bg-gray-50 dark:border-white/[0.1] dark:text-white/60 dark:hover:bg-white/[0.05]"
      >
