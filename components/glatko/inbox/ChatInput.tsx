...
export function ChatInput({ onSend, disabled }: ChatInputProps) {
  ...
  return (
    <div className="sticky bottom-0 z-20 border-t border-gray-200/50 bg-white/80 px-4 py-3 pb-[max(0.75rem,env(safe-area-inset-bottom))] backdrop-blur-sm dark:border-white/[0.06] dark:bg-[#0b1f23]/80 sm:px-6">
