...
export function ChatHeader({
  ...
  return (
    <header className="sticky top-0 z-30 flex items-center gap-3 border-b border-gray-200/50 bg-white/80 px-4 py-3 backdrop-blur-sm dark:border-white/[0.06] dark:bg-[#080808]/80 sm:px-6">
      <Link
        href={`/${locale}/inbox`}
